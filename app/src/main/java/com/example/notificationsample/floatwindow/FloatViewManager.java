...
import com.example.notificationsample.NotificationApplication;
import com.example.notificationsample.widget.FloatView;
...
public class FloatViewManager {
    ...
    private FloatViewManager() {
        floatView = new FloatView(NotificationApplication.getInstance());
    }
